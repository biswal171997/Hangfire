...
{
    public class FuncServiceProviderNew: CachDB10RepositoryBase,IFuncServiceProvider
    { 
     ...
     #region Variable Declaration
        ...
        public FuncServiceProviderNew(ICachDB10ConnectionFactory connectionFactory) : base(connectionFactory)
        {
