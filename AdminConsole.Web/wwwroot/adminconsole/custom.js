...
// Tool Tip
// Coomunication - Inbox - Mail Preview toggle
  $(".table--inbox a").on("click", function(){
    $(".mail-preview").addClass("show");
  });

  $(".mail-preview .close-preview").on("click", function(){
    $(".mail-preview").removeClass("show");
  });
...
// Left Panel Active Starts
$("#basicExampleNav ul li.dropdown a").each(function(){
	$(this).click(function(){
		
	});
});

// Left Panel Active Ends
...
function loadNavigationAct(pgName, pgId, leftlink) {
